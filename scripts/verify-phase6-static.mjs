...
for (const [source, needle] of [[main, 'shoppingCardSnapshot'], [main, "setAttribute('href', href)"], [main, '去淘宝看看'], [main, '实际价格以淘宝结算页为准。'], [card, 'promotionHref'], [domain, 'savedPromotionHref'], [main, '看山·愿望寄存处'], [main, 'home-background.webp'], [main, 'liu-kanshan-wave-transparent.png'], [main, '查看你寄存的愿望清单'], [styles, '.home-hint {'], [styles, 'font-size: 14px']]) {
...
for (const asset of ['public/assets/kanshan-home/home-background.webp', 'public/assets/kanshan-home/liu-kanshan-wave-transparent.png']) if (!existsSync(asset)) throw new Error(`Homepage asset missing: ${asset}`);
