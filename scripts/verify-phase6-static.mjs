...
const productionServices = readFileSync('src/app/production-services.js', 'utf8');
...
if (!main.includes('createProductionServices') || !productionServices.includes('createSupabaseClient(url, publishableKey)')) throw new Error('Production services must compose one shared Supabase client.');
